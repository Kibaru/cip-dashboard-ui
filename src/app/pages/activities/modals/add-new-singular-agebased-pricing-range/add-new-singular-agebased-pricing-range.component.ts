...
@Component({
  selector: 'app-add-new-singular-agebased-pricing-range',
  templateUrl: './add-new-singular-agebased-pricing-range.component.html',
  styleUrls: ['./add-new-singular-agebased-pricing-range.component.css']
})
export class AddNewSingularAgebasedPricingRangeComponent implements IModalDialog {
  ...
  saveDate(){
    ...
    var pricings = {
      range_from : this.fr_date,
      range_to : this.to_date,
    ...
    this.api.addNewStandardSeasonalPricingRange(activity.id , pricings ).subscribe((data)=>{
