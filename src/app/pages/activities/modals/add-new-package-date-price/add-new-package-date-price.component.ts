...
@Component({
  selector: 'app-add-new-package-date-price',
  templateUrl: './add-new-package-date-price.component.html',
  styleUrls: ['./add-new-package-date-price.component.css']
})
export class AddNewPackageDatePriceComponent  implements IModalDialog {
  ...
  savePackagePrice(){
    ...
    this.api.addNewPackageDatePricing(chosen_package.id , this.base_price , this.chosen_date).subscribe((data)=>{
